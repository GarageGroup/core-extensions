...
{
    public static AsyncPipeline<TSuccess, TFailure> PipeParallel<TIn, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TSuccess, TFailure>(
        ...
        Func<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TSuccess> fold)
        where TFailure : struct
    {
        ...
        return pipeline
            .InnerPipeParallel(
                ...
                fifthPipeAsync, sixthPipeAsync, seventhPipeAsync, InnerFold)
            .Pipe(InnerPipe);
