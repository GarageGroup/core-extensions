...
{
    public static AsyncPipeline<(T1, T2, T3, T4, T5, T6, T7, T8), TFailure> PipeParallelValue<TIn, T1, T2, T3, T4, T5, T6, T7, T8, TFailure>(
        ...
        Func<TIn, CancellationToken, ValueTask<Result<T8, TFailure>>> eighthPipeAsync)
