...
{
    public static AsyncPipeline<(T1, T2, T3, T4, T5), TFailure> ForwardParallelValue<TIn, T1, T2, T3, T4, T5, TFailure>(
        ...
        where TFailure : struct
    {
        ...
        return pipeline.MapSuccessValue(InnerForwardAsync).Forward(InnerJoinSuccess<TIn, T1, T2, T3, T4, T5, TFailure>);
